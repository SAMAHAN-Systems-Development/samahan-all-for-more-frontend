    ...
    <>
      <div className="w-[1440px]">
        ...
        <motion.div className="h-[670px] w-[720px] border absolute origin-top-left transform -translate-x-32 bottom-0 z-10 overflow-visible">
          <Ball style="w-32" top={48} left={40} letter={o_ball} />
          <Ball style="w-10 -rotate-12" top={128} left={176} letter={m_ball} />
          <Ball style="w-56 rotate-45" bottom={256} left={0} letter={r_ball} />
          <Ball
            ...
            letter={e_ball}
          />
          <Ball style="w-40" bottom={128} left={112} letter={o_ball} />
          <Ball
          ...
          />
          <Ball
            style="bottom-24 right-[6.5rem] w-24 rotate-45"
            letter={r_ball}
          />
        </motion.div>
        {/* right spheres */}
