  ...
  return (
    <article className="flex relative">
      <div className="hidden lg:block">
        <div>
          <Image
            src="/images/about-page/Blue SMHN Logo Normal.png"
            alt="Left Image 1"
            width={576}
            height={576}
        ...
        <div className="">
          <Image
            src="/images/about-page/Blue E1.png"
            alt="Left Image 2"
            width={576}
            height={576}
        ...
        <div className="">
          <Image
            src="/images/about-page/Blue O3.png"
            alt="Left Image 3"
            width={576}
            height={576}
      ...
      <section className="lg:mx-[15rem]">
        <div className="flex items-center mb-5 mt-28">
          <Image
            src="/images/about-page/A4M S-LOGOHD.png"
            alt=""
            width={576}
            height={576}
          ...
          />
          <Image
            src="/images/about-page/A4M LOGO.png"
            alt="A4M Logo"
            width={576}
            height={576}
      ...
      <div className="hidden lg:block">
        <div>
          <Image
            src="/images/about-page/Blue M1.png"
            alt="Left Image 1"
            width={576}
            height={576}
        ...
        <div className="">
          <Image
            src="/images/about-page/Blue R1.png"
            alt="Left Image 2"
            width={576}
            height={576}
