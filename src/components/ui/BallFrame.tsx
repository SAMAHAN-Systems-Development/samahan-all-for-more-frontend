  ...
  return (
    <>
      ...
      <div className="h-[670px] w-1/2 absolute transform translate-x-[8rem] bottom-0 right-0 z-10 overflow-visible">
        <Ball style="top-10 right-4 w-56" letter={m_ball} />
        <Ball style="top-32 right-72 w-12" letter={r_ball} />
        <Ball style="bottom-80 right-64 w-24" letter={o_ball} />
        <Ball style="bottom-56 right-20 w-40" letter={e_ball} />
        <Ball style="bottom-10 right-40 w-64" letter={r_ball} />
        <Ball style="bottom-64 left-64 w-12" letter={e_ball} />
        <Ball style="bottom-5 left-24 w-56" letter={o_ball} />
      </div>
    </>
  );
}
